...
if __name__ == '__main__':
    ...
    gan.construct(classifier_path=f"checkpoints/{MODEL_NAME}_rsna/{INCEPTION_CKP}/model", classifier_weight=1)
    f"""gan.construct(
        classifier_path=f"/Users/dimitrymindlin/UniProjects/GANterfactual/checkpoints/{MODEL_NAME}_rsna/{INCEPTION_CKP}/model",
        classifier_weight=1)"""
